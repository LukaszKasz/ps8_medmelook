...
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Ps_FacetedsearchFiltersConverterCustom.php';
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'Ps_FacetedsearchFacetsURLSerializerCustom.php';
...
class Ps_FacetedsearchProductSearchProviderCustom implements ProductSearchProviderInterface
{
    private $module;
    ...
    {
        $this->module = $module;
        $this->filtersConverter = new Ps_FacetedsearchFiltersConverterCustom();
        $this->facetsSerializer = new Ps_FacetedsearchFacetsURLSerializerCustom();
    }
