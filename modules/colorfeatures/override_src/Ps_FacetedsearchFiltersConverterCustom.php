...
class Ps_FacetedsearchFiltersConverterCustom
{
            ...
            switch ($facetArray['type']) {
                ...
                case 'id_feature':
                    ...
                    foreach ($facetArray['values'] as $id => $filterArray) {
                        ...
                        if ($facetArray['type'] == 'id_feature' && isset($features[$facetArray['id_key']]) && isset($features[$facetArray['id_key']][$id])) {
                            $filter->setProperty('color', $features[$facetArray['id_key']][$id]);
                        }
