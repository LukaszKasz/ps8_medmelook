...
<div id='sensbitpaczkawruchu-wrapper' class="box">
	<div id='sensbitpaczkawruchu' class='sensbitpaczkawruchu'>
		<img class='sensbitpaczkawruchu-img' style="margin-right:10px" src="{$sensbitpaczkawruchu.module_dir}views/img/services/paczkawruchu.png"/>
		Twój wybrany punkt to <strong>{$sensbitpaczkawruchu.point} ({$sensbitpaczkawruchu.point_label})</strong>
	</div>
</div>