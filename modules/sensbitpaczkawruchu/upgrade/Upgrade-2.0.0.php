...
{
    Configuration::updateValue(SensbitPaczkawRuchu::CFG_SIMPLE_LOG_DAYS, 28);
    return $module->uninstallTabs() && $module->installTabs() && SensbitPaczkawRuchuTools::installModuleHooks($module);
}
