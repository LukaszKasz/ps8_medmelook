	...
	public function __construct() {
		...
		$this->fields_list = array(
			...
			'id_cdc_gtm_order_log' => array(
				'title' => $this->module->l('GTM ID'),
				'align' => 'text-center',
				'class' => 'fixed-width-xs'
			),
            'datalayerExists' => array(
                'title' => $this->module->l('Dl OK'),
                'align' => 'text-center',
                'class' => 'fixed-width-xs',
                'orderby' => false,
                'search' => false,
			...
			'gtm_date_upd' => array(
				'title' => $this->module->l('Last Update GTM'),
				'type' => 'datetime',
