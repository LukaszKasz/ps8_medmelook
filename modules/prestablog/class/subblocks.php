...
class SubBlocksClass extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'multilang' => true,
        'fields' => [
            'hook_name' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 255],
            'template' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 255],
            'id_shop' => ['type' => self::TYPE_INT, 'validate' => 'isunsignedInt', 'required' => true],
            'langues' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
            'select_type' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
            'nb_list' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
            'random' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'required' => true],
            'position' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
            'title_length' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
            'intro_length' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId'],
            'use_date_start' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'required' => true],
            'date_start' => ['type' => self::TYPE_DATE, 'validate' => 'isDateFormat'],
            'use_date_stop' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'required' => true],
            'date_stop' => ['type' => self::TYPE_DATE, 'validate' => 'isDateFormat'],
            'blog_link' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'required' => true],
    ...
    {
        return [
            1 => $this->trans('Latest news', [], 'Modules.Prestablog.Subblocks'),
            2 => $this->trans('Oldest news', [], 'Modules.Prestablog.Subblocks'),
            3 => $this->trans('Most commented news', [], 'Modules.Prestablog.Subblocks'),
            4 => $this->trans('Least commented news', [], 'Modules.Prestablog.Subblocks'),
            5 => $this->trans('Most read news', [], 'Modules.Prestablog.Subblocks'),
            6 => $this->trans('Least read news', [], 'Modules.Prestablog.Subblocks'),
        ];
    }

    public function getListeHook()
    {
        $displayCustomHook = 'displayCustomHook - ' . $this->trans('Custom hook on your tpl file', [], 'Modules.Prestablog.Subblocks');
        $displayCustomHook .= ' - ' . $this->trans('FrontOffice', [], 'Modules.Prestablog.Subblocks');

        $displayModuleBoard = 'displayModuleBoard - ' . $this->trans('Module home configuration', [], 'Modules.Prestablog.Subblocks');
        $displayModuleBoard .= ' - ' . $this->trans('BackOffice', [], 'Modules.Prestablog.Subblocks');

        return [
            'displayHome' => 'displayHome - ' . $this->trans('Home page', [], 'Modules.Prestablog.Subblocks') . ' - ' . $this->trans('FrontOffice', [], 'Modules.Prestablog.Subblocks'),
