...
class DisplaySlider extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->trans('Display Slider', [], 'Modules.Prestablog.Displayslider');
        $this->description = $this->trans('This module can display a slider', [], 'Modules.Prestablog.Displayslider');
    ...
    /**
     * form that will be display configuration module.
     */
    ...
    protected function getConfigForm()
    {
        ...
        return [
            'form' => [
                'legend' => [
                    'title' => $this->trans('Settings', [], 'Modules.Prestablog.Displayslider'),
                    'icon' => 'icon-cogs',
                ],
                'input' => [
                    [
                        'type' => 'select',
                        'label' => $this->trans('Select a slider', [], 'Modules.Prestablog.Displayslider'),
                ...
                'submit' => [
                    'title' => $this->trans('Save', [], 'Modules.Prestablog.Displayslider'),
                ],
            ],
        ];
    }
