...
<meta name="twitter:title" content="{$prestablog_news_meta->title|escape:'htmlall':'UTF-8'}"/>
<meta name="twitter:description" content="{$prestablog_news_meta->paragraph|escape:'htmlall':'UTF-8'}"/>
<meta name="twitter:image" content="{$prestablog_news_meta_img|escape:'html':'UTF-8'}"/>
{/if}
<!-- Module Presta Blog -->
