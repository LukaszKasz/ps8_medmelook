                            ...
                            <div class="col-lg-9">
                                <select class="custom-select client_number_select" id="dpdpoland_PayerNumber"
                                    ...
                                    {foreach from=$payerNumbers item=payerNumber}
                                        <option value="{$payerNumber.payer_number|escape:'htmlall':'UTF-8'}"{if $selectedPayerNumber == $payerNumber.payer_number} selected="selected"{/if}>{$payerNumber.payer_number|escape:'htmlall':'UTF-8'}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <select class="custom-select col-lg-6 col-sm-6 col-xs-12"
                                            ...
                                            {foreach from=$recipientAddresses item=address}
                                                {capture assign=address_title|escape:'htmlall':'UTF-8'}{$address['alias']|escape:'htmlall':'UTF-8'} - {$address['address1']|escape:'htmlall':'UTF-8'} {$address['postcode']|escape:'htmlall':'UTF-8'} {$address['city']|escape:'htmlall':'UTF-8'}{if !empty($address['state'])} {$address['state']|escape:'htmlall':'UTF-8'}{/if}, {$address['country']|escape:'htmlall':'UTF-8'}{/capture}
                                                <option value="{$address['id_address']|escape:'htmlall':'UTF-8'}"{if $address['id_address'] == $selectedRecipientIdAddress} selected="selected"{/if}>{$address_title|escape:'htmlall':'UTF-8'}</option>
                                            {/foreach}
                                        </select>
                                        <div class="dpdpoland_address info-block mt-1">
                        ...
                        <div id="dpdpoland_shipment_references_container" class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dpdpoland_ref2" class="form-control" autocomplete="off"
                                       value="{if $package->ref2}{$package->ref2|escape:'htmlall':'UTF-8'}{elseif !$loaded_object}{$default_ref2|escape:'htmlall':'UTF-8'}{/if}"/>
