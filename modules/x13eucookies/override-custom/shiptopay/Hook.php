    public static function getHookModuleExecList($hook_name = null)
    {
        ...
        if ($hook_name) {
            ...
            if (Module::isEnabled('x13eucookies') && count($return) > 0) {
                $x13eucookies = Module::getInstanceByName('x13eucookies');
                $return = $x13eucookies->filterModules($return);
            ...
            if (Module::isEnabled('x13eucookies') && count($list) > 0) {
                $x13eucookies = Module::getInstanceByName('x13eucookies');
                $list = $x13eucookies->filterModules($list);
            }
