<form class="payment-form" data-method="POST">
	<div>
		<div class="card col-xs-12 col-lg-8">
			...
			<div id="content-blik-code">
                {if $active_profile}
					<div id="content-blik-oneclick">
						<p>
				...
				<div class="content-insert-code d--none">
					<input id="blik_code"
                    ...
                    {if $is_customer_logged && $is_imoje_blik_oneclick}
						<div class="remember-code-content">
							<div class="float-xs-left">
                            <span class="custom-checkbox">
                                <input id="remember-code-checkbox" type="checkbox">
                                <span>
							...
							<div class="remember-code">
								<label for="remember-code-checkbox">
					...
					<button id="blik-submit" class="btn btn-primary btn-submit-code disabled"
		...
		<div class="modal-blik" id="modal-processing">
			<div class="modal-blik-content" id="modal-processing-content">
				<span id="modal_tip"></span>
			</div>
		</div>

		<div class="modal-blik" id="modal-blik_code">
			<div class="modal-blik-content" id="modal-blik_code-content">
				...
				<input placeholder="{l s='BLIK code' mod='imoje'}"
				       ...
				       maxlength="6">
				<br/>
				<button id="blik-submit_modal" class="btn btn-primary btn-submit-code disabled blik-submit" disabled>
                    {l s='Pay' mod='imoje'}
				</button>
		...
		<div class="modal-blik" id="modal-blik_alias_deactivate-modal">
			<div class="modal-blik-content" id="modal-blik_alias_deactivate-modal-content">
