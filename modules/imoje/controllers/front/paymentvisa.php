...
/**
 * Class ImojePaymentvisaModuleFrontController
 *
 * @property bool display_column_left
 * @property bool display_column_right
 */
class ImojePaymentvisaModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$this->context->smarty->assign([
			'form'                    => $paywall->buildOrderForm(
				...
				Util::getPaymentMethodCode('visa_mobile'))
			),
