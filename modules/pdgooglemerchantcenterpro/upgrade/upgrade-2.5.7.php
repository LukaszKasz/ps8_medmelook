...
{
    Db::getInstance(_PS_USE_SQL_SLAVE_)->Execute('ALTER TABLE `'._DB_PREFIX_.'pdgooglemerchantcenterpro` ADD `features_enabled` tinyint(1) unsigned NOT NULL DEFAULT \'0\'');
